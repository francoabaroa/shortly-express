...
describe('', function() {
  ...
  describe('Link creation:', function() {
    ...
    beforeEach(function(done) {
      ...
      new User({ username: 'Phillip',
        password: '$2a$04$4A1DmkTtOHniuU52HHf.suetxa/LI1/.DUVVLxTIEw15QO.3rgI/6',
        salt: '$2a$04$4A1DmkTtOHniuU52HHf.su'}).save().then(function() {
          var options = {
            'method': 'POST',
  ...
  describe('Account Login:', function() {
    ...
    beforeEach(function(done) {
      new User({ username: 'Phillip',
        password: '$2a$04$4A1DmkTtOHniuU52HHf.suetxa/LI1/.DUVVLxTIEw15QO.3rgI/6',
        salt: '$2a$04$4A1DmkTtOHniuU52HHf.su'
      }).save().then(function() {
        done();
      });
    });
